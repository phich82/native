...
$body=array();
$body["begin"]="<form action=\"carsmake_export.php\" method=get id=frmexport name=frmexport>";
$body["end"]="</form>";
$xt->assignbyref("body",$body);
$xt->assign("html_attrs","lang=\"en\"");
$xt->display("carsmake_export.htm");
...
function ExportToExcel()
{
	...
	header("Content-Disposition: attachment;Filename=carsmake.xls");
...
function ExportToWord()
{
	...
	header("Content-Disposition: attachment;Filename=carsmake.doc");
...
function ExportToXML()
{
	...
	header("Content-Disposition: attachment;Filename=carsmake.xml");
...
function ExportToCSV()
{
	...
	header("Content-Disposition: attachment;Filename=carsmake.csv");
