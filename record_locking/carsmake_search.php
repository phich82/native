...
$mode=SEARCH_SIMPLE;
$templatefile = "carsmake_search.htm";

// for ajax query, used when page buffers new control
if(postvalue("mode")=="inlineLoadCtrl"){
	$mode=SEARCH_LOAD_CONTROL;
	$templatefile = "carsmake_inline_search.htm";
}	
...
$params['xt'] = &$xt;
$params['shortTableName'] = 'carsmake';
$params['origTName'] = $strOriginalTableName;
$params['dataSourceTable'] = "carsmake";
...
//--------------------------------------------------------------------------------------	
	...
	{
	$contents_block["begin"].="action=\"carsmake_list.php\" ";
	}
