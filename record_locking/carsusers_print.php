...
$body["begin"]="<script type=\"text/javascript\" src=\"include/jquery.js\"></script>".
	"<script type=\"text/javascript\" src=\"include/pdf.js\"></script>";
$body["begin"].="<script>".
	"\nvar TEXT_PDF_BUILD1='".jsreplace("")."';".
	"\nvar TEXT_PDF_BUILD2='".jsreplace("")."';".
	"</script>";
if(!postvalue("pdf"))
{
	...
	$body["end"]="<script>
		...
		<iframe name=\"pdf\" class=\"pdf\" style=\"position:absolute;left:-1000px;\">
		</iframe>";
}
...
$templatefile = "carsusers_print.htm";
