...
//	datetime - Short Date
	$value="";
		$value = ProcessLargeText(GetData($data,"datetime", "Short Date"),"","",MODE_VIEW);
	$xt->assign("datetime_value",$value);
	$xt->assign("datetime_fieldblock",true);
////////////////////////////////////////////
//	ip - 
	$value="";
		$value = ProcessLargeText(GetData($data,"ip", ""),"","",MODE_VIEW);
	$xt->assign("ip_value",$value);
	$xt->assign("ip_fieldblock",true);
////////////////////////////////////////////
//	user - 
	$value="";
		$value = ProcessLargeText(GetData($data,"user", ""),"","",MODE_VIEW);
	$xt->assign("user_value",$value);
	$xt->assign("user_fieldblock",true);
////////////////////////////////////////////
//	table - 
	$value="";
		$value = ProcessLargeText(GetData($data,"table", ""),"","",MODE_VIEW);
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	if(count($next))
    {
		...
		$xt->assign("nextbutton_attrs","onclick=\"window.location.href='project41_audit_view.php?".$nextlink."'\"");
	}
	else 
	...
	if(count($prev))
	{
		...
		$xt->assign("prevbutton_attrs","onclick=\"window.location.href='project41_audit_view.php?".$prevlink."'\"");
	}
    else 
...
$templatefile = "project41_audit_view.htm";
if(!$all)
{
