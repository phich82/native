...
$mode=SEARCH_SIMPLE;
$templatefile = "carsmodels_search.htm";

// for ajax query, used when page buffers new control
if(postvalue("mode")=="inlineLoadCtrl"){
	$mode=SEARCH_LOAD_CONTROL;
	$templatefile = "carsmodels_inline_search.htm";
}	
...
$params['xt'] = &$xt;
$params['shortTableName'] = 'carsmodels';
$params['origTName'] = $strOriginalTableName;
$params['dataSourceTable'] = "carsmodels";
...
//--------------------------------------------------------------------------------------	
	...
	{
	$contents_block["begin"].="action=\"carsmodels_list.php\" ";
	}
